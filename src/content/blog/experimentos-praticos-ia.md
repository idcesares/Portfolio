...
Este repositório é vivo: a lista é revisada com frequência para tirar links quebrados ou descontinuados e trazer ferramentas novas relevantes. Se algo aqui parou de funcionar ou você conhece um experimento divertido que devia estar na lista, abra uma issue ou um PR no [repositório no GitHub](https://github.com/idcesares/Experimentos-de-IA).
...
### Claude
O assistente de IA da Anthropic, conhecido por respostas cuidadosas, boa escrita e por ser especialmente forte em programação. Tem versão web, apps de desktop e mobile, e a ferramenta de terminal Claude Code (veja na seção de codificação).
...
### Grok
O chatbot da xAI, embutido no X (Twitter) e disponível como app próprio. Tem um tom mais informal e direto que os concorrentes, o que o torna divertido para comparar respostas.
...
### Gemini, Nano Banana
O modelo de imagem do Google dentro do Gemini, apelidado de "Nano Banana" (hoje na versão Pro). Destaque para edições precisas, como trocar um elemento da foto mantendo o resto idêntico, e para misturar várias imagens em uma só cena, com texto renderizado de forma legível.
...
Sem instalar nada e sem escrever uma linha de código, é só abrir e brincar.
...
### GenType
Descreva um estilo, como "a letra feita de chocolate derretido", e a IA gera um alfabeto inteiro nesse estilo, letra por letra. Dá para regenerar cada letra individual e escrever frases com a fonte criada.
...
### Consensus
Faça uma pergunta do tipo sim ou não ("meditação reduz ansiedade?") e receba um medidor de consenso científico baseado em artigos revisados por pares, com evidência a favor e contra.
...
Achou algo quebrado ou tem um experimento favorito fora da lista? Abra uma issue ou um PR no [repositório no GitHub](https://github.com/idcesares/Experimentos-de-IA). Vamos cocriar?
