...
- **[uBlock Origin](https://ublockorigin.com/)** — Bloqueia anúncios e scripts maliciosos. Muitos ataques começam com anúncios infectados, e esse bloqueador é leve e eficiente.

- **[Privacy Badger](https://privacybadger.org/)** — Impede que sites te rastreiem pela internet. Privacidade também é segurança.

- **[Bitwarden](https://bitwarden.com/)** — Gerenciador de senhas open-source e gratuito. Suas senhas ficam criptografadas e você só precisa lembrar de uma senha mestra.

- **HTTPS Everywhere** — Muitos navegadores já forçam conexões seguras, mas se o seu não faz, essa extensão garante que você navegue sempre com criptografia.
...
1. **Verifique se seu sistema está atualizado**
...
2. **Confirme que suas proteções nativas estão ativas**
...
3. **Instale uBlock Origin no seu navegador**
   - Disponível para Chrome, Firefox, Edge, Safari

4. **Configure um gerenciador de senhas**
   - Bitwarden é grátis, open-source e excelente

5. **Ative autenticação de dois fatores** em e-mail, banco, redes sociais

6. **Desenvolva o hábito de desconfiar**
